...
public static class Dependency
{
    ...
    private static IServiceCollection AddMesagesQueque(
        this IServiceCollection services)
    {
        services.AddSingleton<IMessageQueque<IEnumerable<FileInfoMy>>, 
            InMemoryMesagesQueque<IEnumerable<FileInfoMy>>>();
    ...
    private static IServiceCollection AddFilesCleanerServices(
        this IServiceCollection services)
    {
